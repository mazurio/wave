...
public class CancelAppointmentJob extends Job {
    ...
    public CancelAppointmentJob(Appointment appointment) {
...
//        EventBus.getDefault().post(new InProgress());
    ...
    public void onRun() throws Throwable {
        ...
        try {
            data = rest.cancelAppointment("d.mazurkiewicz", appointment);
        } catch (Exception e) {
            throw new Throwable();
        }
        ...
        EventBus.getDefault().post(new CancelAppointmentDone(data));
    }
