package uk.ac.lancaster.wave.Networking.Jobs.Appointment;
...
public class SetAppointmentJob extends Job {
    ...
    public SetAppointmentJob(Appointment appointment) {
    ...
    public void onRun() throws Throwable {
        ...
        try {
            data = rest.insertAppointment("d.mazurkiewicz", appointment);
        } catch (Exception e) {
            throw new Throwable();
        }

        EventBus.getDefault().post(new Done());
